...
ppIfc q ((Build_ModDecl regs mems regUs memUs sends recvs, tmps), compiled) =
  ...
  ++ concatMap (\(i, (s, (Build_Mem n k p _))) -> condMem n k p $ ppKindDecl q (Array p (Bit (log2_up n))) ++ " " ++ ppMem "WrIdx" (s, i) ++ ";\n") (tag mems)
  ++ concatMap (\(i, (s, (Build_Mem n k p _))) -> condMem n k p $ ppKindDecl q (Array p k) ++ " " ++ ppMem "WrVal" (s, i) ++ ";\n") (tag mems)
  ++ concatMap (\(i, (s, (Build_Mem n k p _))) -> condMem n k p $ ppKindDecl q (Array p Bool) ++ " " ++ ppMem "WrEn" (s, i) ++ ";\n") (tag mems)
  ...
  ++ concatMap (\(i, (s, (Build_MemU n k p))) -> condMem n k p $ ppKindDecl q (Array p (Bit (log2_up n))) ++ " " ++ ppMem "UWrIdx" (s, i) ++ ";\n") (tag memUs)
  ++ concatMap (\(i, (s, (Build_MemU n k p))) -> condMem n k p $ ppKindDecl q (Array p k) ++ " " ++ ppMem "UWrVal" (s, i) ++ ";\n") (tag memUs)
  ++ concatMap (\(i, (s, (Build_MemU n k p))) -> condMem n k p $ ppKindDecl q (Array p Bool) ++ " " ++ ppMem "UWrEn" (s, i) ++ ";\n") (tag memUs)
...
ppMod mod@((Build_ModDecl regs mems regUs memUs sends recvs, tmps), compiled) =
  ...
  ++ concatMap (\(i, (s, (Build_Mem n k p _))) -> condMem n k p $ ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p (Bit (log2_up n))) ++ " decl_" ++ ppMem "WrIdx" (s, i) ++ ",\n") (tag mems)
  ++ concatMap (\(i, (s, (Build_Mem n k p _))) -> condMem n k p $ ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p k) ++ " decl_" ++ ppMem "WrVal" (s, i) ++ ",\n") (tag mems)
  ++ concatMap (\(i, (s, (Build_Mem n k p _))) -> condMem n k p $ ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p Bool) ++ " decl_" ++ ppMem "WrEn" (s, i) ++ ",\n") (tag mems)
  ...
  ++ concatMap (\(i, (s, (Build_MemU n k p))) -> condMem n k p $ ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p (Bit (log2_up n))) ++ " decl_" ++ ppMem "UWrIdx" (s, i) ++ ",\n") (tag memUs)
  ++ concatMap (\(i, (s, (Build_MemU n k p))) -> condMem n k p $ ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p k) ++ " decl_" ++ ppMem "UWrVal" (s, i) ++ ",\n") (tag memUs)
  ++ concatMap (\(i, (s, (Build_MemU n k p))) -> condMem n k p $ ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p Bool) ++ " decl_" ++ ppMem "UWrEn" (s, i) ++ ",\n") (tag memUs)
  ...
  ++ concatMap (\(i, (s, k)) -> condPrint (size k /= 0) $ ppKindDecl 1 k ++ " " ++ ppTmp (s, Prelude.length tmps - 1 - i) ++ ";\n") (tag tmps)
  ...
  ++ concatMap (\(i, (s, (Build_Mem n k p _))) -> condMem n k p $ ppIndent 3 ++ ppMem "WrIdx" (s, i) ++ " = " ++ show (p * log2_up n) ++ "\'h0;\n") (tag mems)
  ++ concatMap (\(i, (s, (Build_Mem n k p _))) -> condMem n k p $ ppIndent 3 ++ ppMem "WrVal" (s, i) ++ " = " ++ show (p * size k) ++ "\'h0;\n") (tag mems)
  ++ concatMap (\(i, (s, (Build_Mem n k p _))) -> condMem n k p $ ppIndent 3 ++ ppMem "WrEn" (s, i) ++ " = " ++ show p ++ "\'h0;\n") (tag mems)
  ...
  ++ concatMap (\(i, (s, (Build_MemU n k p))) -> condMem n k p $ ppIndent 3 ++ ppMem "UWrIdx" (s, i) ++ " = " ++ show (p * log2_up n) ++ "\'h0;\n") (tag memUs)
  ++ concatMap (\(i, (s, (Build_MemU n k p))) -> condMem n k p $ ppIndent 3 ++ ppMem "UWrVal" (s, i) ++ " = " ++ show (p * size k) ++ "\'h0;\n") (tag memUs)
  ++ concatMap (\(i, (s, (Build_MemU n k p))) -> condMem n k p $ ppIndent 3 ++ ppMem "UWrEn" (s, i) ++ " = " ++ show p ++ "\'b0;\n") (tag memUs)
  ++ "\n"
