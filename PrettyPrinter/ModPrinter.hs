...
ppIfc ((Build_ModDecl regs mems regUs memUs sends recvs, tmps), compiled) =
  ...
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppKindDecl 1 (Array p (Bit (log2_up n))) ++ " " ++ ppMem "URq" (s, i) ++ ";\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppKindDecl 1 (Array p Bool) ++ " " ++ ppMem "URqEn" (s, i) ++ ";\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppKindDecl 1 (Array p (Bit (log2_up n))) ++ " " ++ ppMem "UWrIdx" (s, i) ++ ";\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppKindDecl 1 (Array p k) ++ " " ++ ppMem "UWrVal" (s, i) ++ ";\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppKindDecl 1 (Array p Bool) ++ " " ++ ppMem "UWrEn" (s, i) ++ ";\n") (tag memUs)
...
ppMod mod@((Build_ModDecl regs mems regUs memUs sends recvs, tmps), compiled) =
  ...
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p (Bit (log2_up n))) ++ " decl_" ++ ppMem "URq" (s, i) ++ ",\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p Bool) ++ " decl_" ++ ppMem "URqEn" (s, i) ++ ",\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p (Bit (log2_up n))) ++ " decl_" ++ ppMem "UWrIdx" (s, i) ++ ",\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p k) ++ " decl_" ++ ppMem "UWrVal" (s, i) ++ ",\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 1 ++ "output " ++ ppKindImmStart 1 (Array p Bool) ++ " decl_" ++ ppMem "UWrEn" (s, i) ++ ",\n") (tag memUs)
  ...
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 1 ++ "input " ++ ppKindImmStart 1 (Array p k) ++ " " ++ ppMem "URp" (s, i) ++ ",\n") (tag memUs)
  ...
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 3 ++ ppMem "URq" (s, i) ++ " = " ++ show (p * log2_up n) ++ "\'h0;\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 3 ++ ppMem "URqEn" (s, i) ++ " = " ++ show p ++  "\'b0;\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 3 ++ ppMem "UWrIdx" (s, i) ++ " = " ++ show (p * log2_up n) ++ "\'h0;\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 3 ++ ppMem "UWrVal" (s, i) ++ " = " ++ show (p * size k) ++ "\'h0;\n") (tag memUs)
  ++ concatMap (\(i, (s, ((n, k), p))) -> ppIndent 3 ++ ppMem "UWrEn" (s, i) ++ " = " ++ show p ++ "\'b0;\n") (tag memUs)
  ++ "\n"
